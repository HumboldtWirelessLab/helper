...
#ifdef CST
#ifdef CST_PROCFILE
  cst::ChannelStats(DEVICE $device, STATS_DURATION 1000, PROCFILE CST_PROCFILE, STATS_INTERVAL 1000, RSSI_PER_NEIGHBOUR true, FULL_STATS false, SAVE_DURATION 1000 );
#else
  cst::ChannelStats(DEVICE $device, STATS_DURATION 1000, STATS_INTERVAL 1000, RSSI_PER_NEIGHBOUR true, FULL_STATS false, SAVE_DURATION 1000);
#endif
#endif
