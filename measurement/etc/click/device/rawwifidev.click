...
#ifdef CST
#ifdef CST_PROCFILE
  cst::ChannelStats(DEVICE $device, STATS_DURATION 1000, PROCFILE CST_PROCFILE, PROCINTERVAL 1000, NEIGHBOUR_STATS true, FULL_STATS false, SAVE_DURATION 1000 );
#else
  cst::ChannelStats(DEVICE $device, STATS_DURATION 1000, PROCINTERVAL 1000, NEIGHBOUR_STATS true, FULL_STATS false, SAVE_DURATION 1000);
#endif
#endif
