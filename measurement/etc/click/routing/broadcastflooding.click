...
#define FLOODING_STRATEGY 1
  ...
  fl::Flooding(NODEIDENTITY $id, FLOODINGPOLICIES "flp_prob flp_mpr flp_overlay flp_simple", FLOODINGSTRATEGY FLOODING_STRATEGY, FLOODINGPASSIVEACK fl_passive_ack, ABORTTX BCAST_ENABLE_ABORT_TX, DEBUG FLOODING_DEBUG);
