...
#define PROBABILITYFLOODING_FWDPROBALILITY 90
  ...
  flp_prob::ProbabilityFlooding(NODEIDENTITY $id, FLOODINGHELPER fl_helper, FLOODINGDB fl_database, MAXNBMETRIC FLOODING_MAXNBMETRIC, MINNEIGHBOURS 3, FWDPROBALILITY PROBABILITYFLOODING_FWDPROBALILITY, CNTNB2ABORT 0, DEBUG FLOODING_DEBUG);
...
#define FLOODING_STRATEGY 1
  ...
  fl_passive_ack::FloodingPassiveAck(NODEIDENTITY $id, FLOODINGHELPER fl_helper, FLOODINGDB fl_database, DEFAULTRETRIES FLOODING_PASSIVE_ACK_RETRIES, DEFAULTINTERVAL BCAST_RNDDELAYQUEUE_MAXDELAY, DEFAULTTIMEOUT BCAST_FPA_DEFAULTTIMEOUT, ABORTONFINISHED BCAST_FPA_ABORTONFINISH, DEBUG FLOODING_DEBUG);

  fl::Flooding(NODEIDENTITY $id, FLOODINGPOLICIES "flp_prob flp_mpr flp_overlay flp_simple", FLOODINGSTRATEGY FLOODING_STRATEGY, FLOODINGDB fl_database, FLOODINGPASSIVEACK fl_passive_ack, ABORTTX BCAST_ENABLE_ABORT_TX, DEBUG FLOODING_DEBUG);
