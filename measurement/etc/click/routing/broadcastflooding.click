...
#define PROBABILITYFLOODING_FWDPROBALILITY 90
  ...
  //fl_passive_ack::FloodingPassiveAck(DEFAULTRETRIES 5, DEFAULTTIMEOUT 10, DEBUG 4);
...
#define BCAST2UNIC_STRATEGY 1
  ...
  unicfl :: UnicastFlooding(NODEIDENTITY $id, FLOODING fl, LINKTABLE $lt, MAXNBMETRIC 400, CANDSELECTIONSTRATEGY BCAST2UNIC_STRATEGY, DEBUG FLOODING_DEBUG);
#endif
