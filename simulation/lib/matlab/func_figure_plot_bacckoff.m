function [handler_figure] = func_figure_plot_bacckoff(figure_number,matrix1_2D,matrix2_2D,text_label_x,text_label_y,vector_legend,text_legend_title)%,ticks_y_step_size,text_title,legend_on,vector_legend,text_legend_title)%,vector_backoff_window_sizes_standard) 
