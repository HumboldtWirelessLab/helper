%% Function 
% rate_data := one rate
% frame_data := can be mac_frame, rts, cts or ack
function [plcp_framing_duration,time_sifs, time_difs, time_slot, output_xml ] = func_layer_phy(rate_data, frame_mac, is_ism_2_4_ghz, is_ism_5_ghz, is_ism_2_4_and_5_ghz, use_greenfield, dsss_ofdm_use, is_short_guard_interval, bandwidth, number_of_antennas)
%% --------------------------- IEEE 802.11 - DSSS -----------------------------------
            ...
            if ((~isempty(find(vector_rates_80211 == rate_data, 1)))  && use_greenfield == 0 && is_ism_2_4_ghz == 1) % && use_802_11 == 1)
                ...
                [plcp_framing_bits,plcp_framing_duration, output_xml_1] = func_phy_ieee80211(rate_data,frame_mac);
            ...
            elseif ((~isempty(find(vector_rates_80211b == rate_data, 1))) && is_ism_2_4_ghz == 1)
                ...
                [plcp_framing_bits,plcp_framing_duration, output_xml_1] = func_phy_ieee80211b(rate_data,frame_mac,use_greenfield);
            ...
            elseif ((~isempty(find(vector_rates_80211a == rate_data, 1))) && is_ism_5_ghz == 1)
                ...
                [plcp_framing_bits,plcp_framing_duration, output_xml_1] = func_phy_ieee80211a(rate_data,frame_mac);
            ...
            elseif ((~isempty(find(vector_rates_80211g == rate_data, 1))) && is_ism_2_4_ghz == 1)
                ...
                [plcp_framing_bits,plcp_framing_duration, output_xml_1] = func_phy_ieee80211g(rate_data,frame_mac,use_greenfield, dsss_ofdm_use);
            ...
            elseif ((~isempty(find(vector_rates_80211n == rate_data, 1))) && is_ism_2_4_and_5_ghz == 1)
                ...
                [plcp_framing_bits,plcp_framing_duration, output_xml_1] = func_phy_ieee80211n(mcs_index_data,frame_mac,is_short_guard_interval, bandwidth,use_greenfield );
