...
sed "s#,# #g" $EVALUATIONSDIR/flooding_lasthop_fwd_pdr.csv > $EVALUATIONSDIR/flooding_lasthop_fwd_pdr.mat
sed "s#,# #g" $EVALUATIONSDIR/flooding_lasthop_fwd_pkt_cnt.csv > $EVALUATIONSDIR/flooding_lasthop_fwd_pkt_cnt.mat
sed "s#,# #g" $EVALUATIONSDIR/flooding_lasthop_tx_pdr.csv > $EVALUATIONSDIR/flooding_lasthop_tx_pdr.mat
sed "s#,# #g" $EVALUATIONSDIR/flooding_lasthop_tx_pkt_cnt.csv > $EVALUATIONSDIR/flooding_lasthop_tx_pkt_cnt.mat
sed "s#,# #g" $EVALUATIONSDIR/flooding_src_pdr.csv > $EVALUATIONSDIR/flooding_src_pdr.mat
...
sed "s#,# #g" $EVALUATIONSDIR/flood_reach.csv > $EVALUATIONSDIR/flood_reach.mat
