function [taskset, order] = sort_lpt(taskset, varargin)
%The Longest Processing Time first is a scheduling strategy described by Blazewicz. 
%
...
[taskset order]=sort(taskset,wproctime,'dec'); % sort taskset
