...
%      - Set of tasks 
%    KW:
%      - Key word - define type of TransformFunction: 
...
%   $Revision: 1824 $  $Date: 2007-09-21 14:18:23 +0200 (pá, 21 IX 2007) $
...
%==============================================================================
    ...
    % tests if ordered data types match userparams in list 
...
function emptyValues = getemptyvalues(dataTypes)
    emptyValues = cell(1,length(dataTypes));
    for i = 1:length(dataTypes)
        emptyValues{i} = eval([dataTypes{i} '([])']);
    end
