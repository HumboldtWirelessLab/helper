...
int calc_eff_snrs(struct iwl5000_bfee_notif *bfee, double eff_snrs[MAX_NUM_RATES][4]);
void shift_power_tables(int8_t shift);

int calc_eff_snrs_tostr(struct iwl5000_bfee_notif *bfee, double eff_snrs[MAX_NUM_RATES][4], char* retstr, char *hostname);
