...
int calc_eff_snrs_tostr(struct iwl5000_bfee_notif *bfee,
		double eff_snrs[MAX_NUM_RATES][4], char *retstr, char *hostname)
{
	...
	strcpy(retstr, "hostname: ");
	strcat(retstr, hostname);
	strcat(retstr, " eff_snrs:\n");
